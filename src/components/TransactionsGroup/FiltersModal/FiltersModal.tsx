            ...
            <View style={styles.innerModal}>
                <View style={styles.filtersContainer}>
                    ...
                    {forFamily && 
                        <View style={styles.filterGroup}>
                            <View style={styles.withClear}>
                                <Text style={styles.filterBtnText}>Filter by family member</Text>
                                <Text style={[styles.closeText, ((!memberSelect.includes("Any Member")) ? { color: '#526DC2' } : {color: '#A9A9A9'})]}
                                onPress={() => {
                            ...
                            <View style={styles.rowFlex}>
                                {familyMembers.map((name: any) => {
                                    ...
                                    return (
                                        <Pressable style={[styles.memberBtn, selected ? styles.selectedInput : styles.unselectedInput]} 
                                            onPress={() => {
                                                if (selected) {
                                                    const newSelected = memberSelect.filter((val: any) => val !== name)
                                            ...
                                            key={name}
                                            >
                                            <Text style={[styles.filterBtnText, selected ? { color: '#525454' } : {color: '#A9A9A9'}]}>{name}</Text>
                                            {selected && (
