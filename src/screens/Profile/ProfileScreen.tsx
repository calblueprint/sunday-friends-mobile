  ...
  return (
    <View style={styles.flatListItem}>
      ...
      <Pressable style={styles.switch}>
        <Text style={globalStyles.body2}>Switch</Text>
      </Pressable>
    </View>
  );
}
...
function ProfileScreen() {
  ...
  const renderItem = ({ item }) => <Item name={item.name} role={item.role} />;
