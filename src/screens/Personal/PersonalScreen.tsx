    ...
    <View style={styles.homeContainer}>
      ...
      <View style={styles.headline}>
        <Text style={[globalStyles.h3Bold, { color: "#272929" }]}>
          Morning, {user.full_name.split(" ")[0]}
        </Text>
        ...
        <View style={styles.topHalfContainer}>
          <View style={styles.balanceContainer}>
            <Text style={[styles.balanceText, { color: "#253C85" }]}>
              {user.suspended ? "N/A" : personalBalance}
            </Text>
            <Text style={globalStyles.overline2}>
              {user.suspended ? "ACCOUNT SUSPENDED" : "MY BALANCE"}
            </Text>
          </View>
          <Pressable
