...
import FamilyNameScreen from "../screens/Invite/FamilyNameScreen";
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        options={{ headerShown: false, title: "Signup1" }}
      />
      <Stack.Screen
        name="Signup2"
        component={Signup2Screen}
        options={{ headerShown: false, title: "Signup2" }}
      />
      <Stack.Screen
        name="Signup3"
        component={Signup3Screen}
        options={{ headerShown: false, title: "Signup3" }}
      />
      <Stack.Screen
        name="Invite"
      ...
      <Stack.Screen
        name="Error1"
        component={Error1Screen}
        options={{ headerShown: false, title: "Error1" }}
      />
      <Stack.Screen
        name="Error2"
        component={Error2Screen}
        options={{ headerShown: false, title: "Error2" }}
      />
      <Stack.Screen
        name="EditInvite"
      ...
      <Stack.Screen
        ...
        options={{ headerShown: false, title: "FamilyName" }}
      />
    </Stack.Navigator>
  );
};
